...
import { Menu, X, Search, User, LogOut, Heart, ShoppingCart, Cake, ChevronDown } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            >
              ...
              <h1 className={`text-2xl font-extrabold drop-shadow-lg transition-all duration-300 ${
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              >
                Home
                <span className={`absolute left-1/2 -bottom-1 w-0 h-0.5 bg-pink-500 group-hover:w-4/5 transition-all duration-300 group-hover:left-1/10 ${
                ...
                <Link
                  ...
                  className={`px-4 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center space-x-3 ${
                    isScrolled 
                      ? "bg-pink-50 text-pink-600" 
                      : "bg-white/20 text-white"
                  } ${location.pathname === "/products" ? "bg-pink-500 text-white" : ""}`}
                >
                  <span>Products</span>
                </Link>
                ...
                <Link
                  ...
                  className={`px-4 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-between ${
                    isScrolled 
                      ? "bg-pink-50 text-pink-600" 
                      : "bg-white/20 text-white"
                  } ${location.pathname === "/wishlist" ? "bg-pink-500 text-white" : ""}`}
                >
                  <div className="flex items-center space-x-3">
                    <Heart className="h-5 w-5" />
                    <span>Wishlist</span>
